...
final class AdminRoutes implements RouteFamily
{
    public static function routes(): array
    {
        ...
        return [
            ...
            RouteDef::live('GET', '/admin/users', 'admin', 'Every sign-in account of this install, blocked ones included (this is how FIREFLY_MACHINE_OPERATOR is chosen, so it answers WITHOUT a resolved operator).', [$a, 'users'], ['phase' => 'P10', 'operator' => false]),
            RouteDef::live('POST', '/admin/first-user', 'write', 'Bootstrap ONLY: create the FIRST sign-in account of an install that has none; it becomes the owner. Refuses once any account exists.', [$a, 'createFirstUser'], ['phase' => 'P12', 'dryRun' => false, 'operator' => false]),
            RouteDef::live('POST', '/admin/users', 'admin', 'Create another sign-in account (email + password).', [$a, 'createUser'], ['phase' => 'P12', 'dryRun' => false, 'operator' => false]),
            RouteDef::live('POST', '/admin/users/{id}/password', 'admin', 'Set an existing sign-in account\'s password; {id} is its numeric id or its email address.', [$a, 'setUserPassword'], ['phase' => 'P12', 'dryRun' => false, 'operator' => false]),
