...
/**
 * One row of `category_transaction_journal` — the link between a journal and its category. Firefly models this as a pivot
 ...
 */
final class CategoryJournalRow extends Model
{
    public $timestamps = false;

    protected $table   = 'category_transaction_journal';
