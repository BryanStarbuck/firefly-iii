...
/**
 * One row of `tag_transaction_journal` — the link between a journal and one of its tags. Firefly models this as a pivot
 ...
 */
final class TagJournalRow extends Model
{
    public $timestamps = false;

    protected $table   = 'tag_transaction_journal';
